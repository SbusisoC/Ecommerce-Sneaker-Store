...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        slideModels.add(new SlideModel(R.drawable.banner2,"Discount On All Brands", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner3,"50% OFF", ScaleTypes.CENTER_CROP));
